    ...
    foreach($_POST['checkBoxArray'] as $postValueId) {
        ...
        switch($bulk_options) {
            ...
            case 'draft':
                ...
                break;
            case 'delete':
                $query = "DELETE FROM postss WHERE post_id = $postValueId";
            ...
            case 'clone':
                ...
                while($row = mysqli_fetch_array($select_post_query)) {
                    ...
                    $post_tags = $row['post_tags'] ?? 'Not tags';
...
<?php
    ...
    while($row = mysqli_fetch_assoc($select_posts)) {
        ...
        $select_categiries_id = mysqli_query($connection,$query);
        
        while($row = mysqli_fetch_assoc($select_categiries_id)) {
            $cat_id = $row['cat_id'];
        ...
        echo <<<HTML
            <td>
                <form method="post">
                    <input rel='$post_id' class='btn btn-danger del_link' type='submit' name='delete' value='Delete'>
                </form>
            </td>    
        HTML;
